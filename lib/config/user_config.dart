...
class UserConfig extends BaseConfig {
  ...
  /// 获取登录状态
  bool get loginStatus => (user ?? BaseEmpty.emptyUser).type == "1";
  ...
  ///上次阅读文章时间
  set setLastDailyTime(int time) =>
      spInstance.putInt(UserKeys.k_LAST_DAILY, time);

  ///上次阅读文章时间
  int get lastDailyTime =>
      spInstance.getInt(UserKeys.k_LAST_DAILY, defaultVal: -1);
}
...
class UserKeys {
  ...
  static const k_LAST_DAILY = "k_LAST_DAILY";
}
