...
import 'package:flutter_boss_says/generated/json/folder_entity_helper.dart';
import 'package:flutter_boss_says/data/entity/daily_entity.dart';
import 'package:flutter_boss_says/generated/json/daily_entity_helper.dart';
import 'package:flutter_boss_says/data/entity/banner_entity.dart';
import 'package:flutter_boss_says/generated/json/banner_entity_helper.dart';
...
import 'package:flutter_boss_says/generated/json/his_fav_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
			...
			case DailyEntity:
				return dailyEntityFromJson(data as DailyEntity, json) as T;
			case BannerEntity:
			...
			case HisFavEntity:
				return hisFavEntityFromJson(data as HisFavEntity, json) as T;
			case GuidBossEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			...
			case DailyEntity:
				return dailyEntityToJson(data as DailyEntity);
			case BannerEntity:
			...
			case HisFavEntity:
				return hisFavEntityToJson(data as HisFavEntity);
			case GuidBossEntity:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		}	else if(type == (FolderEntity).toString()){
			return FolderEntity().fromJson(json);
		}	else if(type == (DailyEntity).toString()){
			return DailyEntity().fromJson(json);
		...
		}	else if(type == (HisFavEntity).toString()){
			return HisFavEntity().fromJson(json);
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		...
		}	else if(<FolderEntity>[] is M){
			return data.map<FolderEntity>((e) => FolderEntity().fromJson(e)).toList() as M;
		}	else if(<DailyEntity>[] is M){
			return data.map<DailyEntity>((e) => DailyEntity().fromJson(e)).toList() as M;
		...
		}	else if(<HisFavEntity>[] is M){
			return data.map<HisFavEntity>((e) => HisFavEntity().fromJson(e)).toList() as M;
